function fetchMovies() {
    ...
    fetch('https://api.kinopoisk.dev/v1.4/movie?page=1&limit=10&type=tv-series', {
        headers: {
            'X-API-KEY': apiKey
        }
    })
...
fetchMovies()
    .then(() => console.log('Данные о сериалах успешно загружены'))
    .catch(error => console.error('Произошла ошибка при загрузке данных о сериалах:', error));
};
